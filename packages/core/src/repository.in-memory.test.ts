...
const vehicles: Vehicle[] = [
  { id: "car-1", userId: "user-1", brand: "BMW", model: "320d", year: 2019, plate: "CB1234AB", vin: null, bodyType: "sedan", fuelType: "diesel", firstRegistration: null },
  { id: "car-2", userId: "user-2", brand: "Audi", model: "A4", year: 2020, plate: null, vin: null, bodyType: null, fuelType: null, firstRegistration: null },
];
...
describe("InMemoryVehicleRepository writes", () => {
  ...
  it("records how a Vehicle is powered, and lets it be corrected", async () => {
    ...
    const corrected = await repo.update(created.id, { fuelType: "petrol", firstRegistration: null });
...
describe("InMemoryServiceRecordRepository writes", () => {
  it("creates, updates and deletes a Service Record for a Vehicle", async () => {
    const cars: Vehicle[] = [
      { id: "car-1", userId: "user-1", brand: "BMW", model: "320d", year: null, plate: null, vin: null, bodyType: null, fuelType: null, firstRegistration: null },
    ];
