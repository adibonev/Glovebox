...
```
Glovebox: документи за кола
```
Самò `Glovebox` **е заето** в App Store (имената са глобално уникални). Иконата на телефона
пак изписва „Glovebox" — това идва от `expo.name` в `app.json`, не оттук.
