...
export default function AboutPage() {
  return (
    <LegalPage title="За нас">
      ...
      <p>
        И да пазим това, което ни даваш. Данните ти стоят в Европейския съюз и не ги продаваме.
        Снимката на талона се разчита на телефона ти и не се качва никъде. Ако решиш да си
        тръгнеш, изтриваш акаунта с едно натискане и с него изчезва всичко.
      </p>
      <p>Засега е безплатно, без карта и без уловки.</p>
